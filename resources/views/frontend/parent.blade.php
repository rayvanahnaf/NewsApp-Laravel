                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="single-post.html" class="img-bg d-flex align-items-end"
                                        style="background-image: url('{{ asset('frontend/assets/img/post-slide-1.jpg') }}');">
                                ...
                                <div class="swiper-slide">
                                    <a href="single-post.html" class="img-bg d-flex align-items-end"
                                        style="background-image: url('{{ asset('frontend/assets/img/post-slide-2.jpg') }}');">
                                        <div class="img-bg-inner">
                                ...
                                <div class="swiper-slide">
                                    <a href="single-post.html" class="img-bg d-flex align-items-end"
                                        style="background-image: url('{{ asset('frontend/assets/img/post-slide-3.jpg') }}');">
                                        <div class="img-bg-inner">
                                ...
                                <div class="swiper-slide">
                                    <a href="single-post.html" class="img-bg d-flex align-items-end"
                                        style="background-image: url('{{ asset('frontend/assets/img/post-slide-4.jpg') }}');">
                                        <div class="img-bg-inner">
